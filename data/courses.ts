// Full course data with Abrasivism (SSO + PASAIDA) sales copy
// Koray Contextual Vector heading structure applied
...
export const courses: CourseData[] = [
  {
    ...
    slug: 'browser-os',
    name: 'Browser OS',
    tagline: 'Kill Tab Hell. Reclaim 500+ Hours/Year.',
    price: '$497',
    priceValue: 497,
    modules: 6,
    runtime: '~8 hours',
    ...
    action: {
      ...
      urgency: '6 modules. Implementation time: one weekend. ROI timeline: first week.'
    },

    curriculum: [
      { id: '01', title: 'The Cost of Chaos', description: 'Quantify what tab hell actually costs you. Calculate your personal cognitive tax.', duration: '45 min' },
      { id: '02', title: '5-Space Architecture', description: 'The spatial system that matches how your brain processes context.', duration: '90 min' },
      { id: '03', title: 'Arc Browser Deployment', description: 'Step-by-step setup of your production browser environment.', duration: '60 min' },
      { id: '04', title: 'Context Preservation', description: 'The spatial memory trick that makes switching instant.', duration: '75 min' },
      { id: '05', title: 'Information Triage', description: 'What stays, what goes, what moves. Decision frameworks for tab management.', duration: '60 min' },
      { id: '06', title: 'Maintenance Protocol', description: 'Weekly rituals that prevent chaos from returning.', duration: '45 min' }
    ],
    ...
    faq: [
      { q: 'Do I need Arc Browser?', a: 'Arc is the recommended browser for full implementation, but the 5-Space Architecture principles work with any browser that supports profiles or containers.' },
      { q: 'How long until I see results?', a: 'Most operators report significant reduction in context-switching friction within the first week. Full system deployment takes one weekend.' },
      { q: 'What if I\'ve tried other productivity systems?', a: 'Browser OS isn\'t a productivity system. It\'s an information architecture. It works because it matches how your brain processes spatial context, not how apps think you should work.' }
    ]
  },

  {
    ...
    tagline: 'Stop Renting AI. Start Owning It.',
    price: '$997',
    priceValue: 997,
    modules: 12,
    runtime: '~20 hours',
    ...
    action: {
      ...
      urgency: '12 modules. Break-even timeline: 6 months or less. Savings horizon: $60-540k annually.'
    },

    curriculum: [
      { id: '01', title: 'The True Cost of API Dependency', description: 'Calculate what you\'re really paying for cloud AI.', duration: '60 min' },
      { id: '02', title: 'Sovereignty vs. Convenience', description: 'The framework for hybrid deployment decisions.', duration: '90 min' },
      { id: '03', title: 'Local Inference Economics', description: 'Hardware costs, performance curves, break-even analysis.', duration: '120 min' },
      { id: '04', title: 'Data Residency & Compliance', description: 'What your legal team needs to know about AI data flows.', duration: '90 min' },
      { id: '05', title: 'Vendor Lock-in Assessment', description: 'Measure and mitigate your current exposure.', duration: '60 min' },
      { id: '06', title: 'Hybrid Architecture Patterns', description: 'Design patterns for cloud-local hybrid deployments.', duration: '120 min' },
      { id: '07', title: 'TCO Modeling Framework', description: 'Build the spreadsheet that changes the conversation.', duration: '90 min' },
      { id: '08', title: 'Migration Planning', description: 'Phase your transition without breaking production.', duration: '90 min' },
      { id: '09', title: 'Procurement Strategy', description: 'Hardware selection, vendor negotiation, timing.', duration: '60 min' },
      { id: '10', title: 'ROI Communication', description: 'Present the case to executives who don\'t speak AI.', duration: '60 min' },
      { id: '11', title: 'Risk Mitigation', description: 'What can go wrong and how to prevent it.', duration: '60 min' },
      { id: '12', title: 'Continuous Optimization', description: 'Ongoing cost monitoring and optimization cycles.', duration: '60 min' }
    ],
    ...
    faq: [
      { q: 'Is this anti-cloud?', a: 'No. This is pro-economics. Cloud AI makes sense for some workloads. The course teaches you how to identify which ones.' },
      { q: 'Do I need a technical background?', a: 'The course is designed for technical leaders who need to make business cases. You don\'t need to deploy the infrastructure yourself.' },
      { q: 'What about model quality?', a: 'Local models have reached parity with cloud models for many use cases. The course covers capability mapping so you know where local works and where it doesn\'t.' }
    ]
  },

  {
    ...
    tagline: 'Extract Your Expertise. Escape the Bottleneck.',
    price: '$1,997',
    priceValue: 1997,
    modules: 7,
    runtime: '~15 hours',
    ...
    action: {
      ...
      urgency: '7 modules. First SOP deployed: Week 1. Full system: 90 days. Valuation impact: $3M+'
    },

    curriculum: [
      { id: '01', title: 'The Bottleneck Audit', description: 'Map where your expertise creates dependency.', duration: '90 min' },
      { id: '02', title: 'The 5 SOP Types', description: 'Process, decision, communication, analysis, and judgment SOPs.', duration: '120 min' },
      { id: '03', title: 'Extraction Interviews', description: 'The technique for pulling tacit knowledge into explicit format.', duration: '120 min' },
      { id: '04', title: 'Documentation Architecture', description: 'Where SOPs live, how they\'re accessed, who maintains them.', duration: '90 min' },
      { id: '05', title: 'Decision Tree Design', description: 'Convert judgment calls into flowcharts your team can follow.', duration: '150 min' },
      { id: '06', title: 'Training & Handoff', description: 'How to transfer knowledge without being the eternal trainer.', duration: '90 min' },
      { id: '07', title: 'Maintenance Protocol', description: 'Keep SOPs alive as the business evolves.', duration: '60 min' }
    ],
    ...
    faq: [
      { q: 'How is this different from regular documentation?', a: 'Regular documentation captures what you do. Codified Genius captures how you think. The 5 SOP types cover judgment and decision-making, not just procedures.' },
      { q: 'What if my expertise is too complex to document?', a: 'The extraction interview technique is specifically designed for tacit knowledge—the stuff you do automatically without thinking about it. That\'s the valuable part.' },
      { q: 'How long until I see results?', a: 'First SOP deployed in week 1. Most founders report significant time savings within 30 days. Full system deployment takes 90 days.' }
    ]
  },

  {
    ...
    tagline: 'Production AI. Local-First. Zero Compromise.',
    price: '$2,497',
    priceValue: 2497,
    modules: 41,
    runtime: '~60 hours',
    ...
    action: {
      ...
      urgency: '41 modules. The complete production AI curriculum. From browser to autonomous agents.'
    },

    curriculum: [
      { id: '01-10', title: 'Foundation Layer', description: 'Local LLM deployment, model selection, inference optimization.', duration: '~15 hours' },
      { id: '11-20', title: 'Data Acquisition', description: 'Browser automation, web scraping, API integration, data pipelines.', duration: '~12 hours' },
      { id: '21-30', title: 'Memory Architecture', description: 'Vector stores, RAG implementation, context management, retrieval optimization.', duration: '~15 hours' },
      { id: '31-37', title: 'Orchestration Layer', description: 'Multi-agent systems, task routing, error handling, state management.', duration: '~10 hours' },
      { id: '38-41', title: 'Governance & Ops', description: 'Monitoring, evaluation, cost tracking, compliance controls.', duration: '~8 hours' }
    ],
    ...
    faq: [
      { q: 'Is this for beginners?', a: 'No. This course assumes you\'ve used AI tools and want to build production systems. If you\'re new to AI, start with Claude 101 (included with purchase).' },
      { q: 'What tech stack does it cover?', a: 'Claude, Ollama, LangChain, Playwright, ChromaDB, PostgreSQL with pgvector, and more. The principles apply regardless of specific tools.' },
      { q: 'How is this different from other AI courses?', a: 'Most courses teach you to use AI. This course teaches you to build AI systems. The difference is production-grade architecture, not API calls.' }
    ]
  },

  {
    ...
    slug: 'llm-ops',
    name: 'LLM Ops',
    tagline: 'Zero Trust AI. Production Discipline.',
    price: '$997',
    priceValue: 997,
    modules: 8,
    runtime: '~12 hours',
    ...
    action: {
      ...
      cta: 'Get Instant Access — $997',
      urgency: '8 modules. The production discipline layer. Cost reduction: 50-80%. Compliance confidence: 100%.'
    },

    curriculum: [
      { id: '01', title: 'The Ops Gap', description: 'What production AI requires that most teams skip.', duration: '60 min' },
      { id: '02', title: 'Cost Architecture', description: 'Track, attribute, and optimize AI spending.', duration: '90 min' },
      { id: '03', title: 'Observability Stack', description: 'Logging, tracing, and monitoring for LLM systems.', duration: '120 min' },
      { id: '04', title: 'Guardrails & Safety', description: 'Input/output filtering, jailbreak prevention, safety layers.', duration: '90 min' },
      { id: '05', title: 'Compliance Framework', description: 'SOC2, HIPAA, GDPR alignment for AI systems.', duration: '90 min' },
      { id: '06', title: 'Evaluation Pipeline', description: 'Hallucination detection, quality scoring, regression testing.', duration: '120 min' },
      { id: '07', title: 'Incident Response', description: 'When things go wrong: playbooks for AI failures.', duration: '60 min' },
      { id: '08', title: 'Continuous Improvement', description: 'Feedback loops, model updates, ongoing optimization.', duration: '60 min' }
    ],
    ...
    faq: [
      { q: 'Is this only for enterprises?', a: 'Any team running AI in production benefits from ops discipline. The frameworks scale from startup to enterprise.' },
      { q: 'What if we\'re just starting with AI?', a: 'Build ops in from the start. It\'s easier to deploy than to retrofit. The course covers both greenfield and brownfield scenarios.' },
      { q: 'What compliance frameworks are covered?', a: 'SOC2, HIPAA, and GDPR alignment. The principles apply to other frameworks—the course teaches the methodology, not just the checklist.' }
    ]
  }
];
